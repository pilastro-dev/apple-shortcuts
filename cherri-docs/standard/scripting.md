...
A list is immutable — there is no action or syntax to add items to it after creation. If you need to build a dynamic collection, use an [`array`](../types.md#array) variable, which supports the `+=` operator.
